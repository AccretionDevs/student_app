  ...
  Widget build(BuildContext context) {
    return FutureBuilder(
        ...
        builder: (context, snapshot) {
          ...
          String CGPA = "NA";
          if (json_external.length > 1) {
            CGPA = json_external[json_external.length - 1]['Result'][1]['Value']
                .toString();
          } else if (json_external.length == 1) {
            CGPA = json_external[0]['Result'][0]['Value'].toString();
          }
          return Scaffold(
            appBar: AppBar(
              flexibleSpace: Upper(
                  ...
                  SizedBox(
                    ...
                    child: Column(
                      children: [
                        ...
                        CircleAvatar(
                          radius: 60,
                          backgroundImage: MemoryImage(base64Decode(baseImage)),
                        ...
                        child: Column(
                          ...
                          children: <Widget>[
                            ...
                            SizedBox(
                                height:
                                MediaQuery.of(context).size.height * 0.01),
                            Text(CGPA, style: TextStyle(fontSize: 16.0)),
                          ],
                        ),
                      ),
                    ),
